1. **YouTube / video transcript (only when source type is youtube):**
  - The evidence is spoken text (often repetitive or meandering). Produce a **standalone article**
    ...
    with enough substance that the reader grasps the whole video without watching it.
    ...
    (for example `### [12:30-18:00] Why X matters`). Under each, explain claims, reasoning,
